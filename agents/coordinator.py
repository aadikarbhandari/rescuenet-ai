...
class CoordinatorAgent:
    ...
    def prioritize_victims(self, victims: List[VictimState]) -> List[VictimState]:
        ...
        sorted_victims = sorted(victims, key=victim_score)
    ...
    def assign_missions(self, victims: List[VictimState]) -> List[MissionAssignment]:
        ...
        # Filter out victims already assigned
        unassigned = [v for v in victims if v.assigned_drone is None]
        ...
        for victim in prioritized:
            ...
            # Find best available drone (not already assigned in this cycle)
            ...
            if best_drone_id in self.assigned_drones:
                ...
                # try to find another available drone (not assigned yet)
